    ...
    for y=world.y,world.y+world.h-1 do
        for x=world.x,world.x+world.w-1 do
            ...
            elseif sprite >= g_spr_follower and sprite < g_spr_follower + 4 then
                ...
                local count = mget(x, y - 1) - g_spr_count + 1
                for i=1,count do
                    local dx = i * (i % 2 * 2 - 1)
...
__map__

...

